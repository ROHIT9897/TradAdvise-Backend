...
def build_features(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # ── Pre-compute ALL moving averages first ─────────
    # Every section below can safely use these
    ...
    # ── 3. MA ratios (price vs moving average) ────────
    ...
    # Use future_ret (not trend) — more honest prediction target
    ...
    # Drop last 3 rows — no future price available for them
    f = f.iloc[:-3]
